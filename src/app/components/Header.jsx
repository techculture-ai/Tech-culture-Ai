        ...
        <header className={`w-full h-20  flex items-center justify-center fixed top-0 left-0 z-[100] ${isScrolled === true && 'scroll'}`}>
            <div className='container flex items-center justify-between'>
                ...
                <nav className={`flex items-center gap-7 fixed top-0 -right-[100%] lg:static bg-[#040416] lg:bg-transparent flex-col lg:flex-row h-screen lg:h-auto z-[101] opacity-0 lg:opacity-100 ${isOpenNav === true && 'opacity-100 right-0'}`}>
                    <Link href={"#"} className='text-white text-[17px] opacity-90 hover:opacity-100 hover:text-primary transition-all' onClick={()=>setIsOpenNav(false)} >Who We Are </Link>
                    <Link href={"#"} className='text-white text-[17px] opacity-90 hover:opacity-100 hover:text-primary transition-all' onClick={()=>setIsOpenNav(false)} >What We Do  </Link>
                    <Link href={"#"} className='text-white text-[17px] opacity-90 hover:opacity-100 hover:text-primary transition-all' onClick={()=>setIsOpenNav(false)} > Portfolio  </Link>
                    <Link href={"#"} className='text-white text-[17px] opacity-90 hover:opacity-100 hover:text-primary transition-all' onClick={()=>setIsOpenNav(false)} >Technologies</Link>
                    <Link href={"#"} className='text-white text-[17px] opacity-90 hover:opacity-100 hover:text-primary transition-all' onClick={()=>setIsOpenNav(false)} >Client Stories </Link>
                    <Link href={"#"} className='text-white text-[17px] opacity-90 hover:opacity-100 hover:text-primary transition-all' onClick={()=>setIsOpenNav(false)} >Our Experts  </Link>
                    <Link href={"#"} className='text-white text-[17px] opacity-90 hover:opacity-100 hover:text-primary transition-all' onClick={()=>setIsOpenNav(false)} >Contact Us  </Link>
