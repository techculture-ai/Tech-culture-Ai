...
const OurWorkspace = () => {
  ...
  const fetchWorkspaceImages = async () => {
    try {
      setLoading(true);
      const response = await fetch(`${apiBaseUrl}/api/gallery?galleryType=image`);
      ...
      if (data.success && data.gallery) {
        ...
        const uniqueCategories = [...new Set(data.gallery.map(img => img.category))];
    ...
    return (
      <div className="min-h-screen bg-[#000319] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-white/80 text-lg font-medium">Loading workspace images...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
              ...
              <div className="flex items-center gap-8">
                <div className="text-center">
                  <div className="text-3xl font-bold text-white mb-1">{images.length}</div>
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-white mb-1">{filteredImages.length}</div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-gray-800/50 border border-gray-700/50 rounded-lg px-4 py-3 pr-10 text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent min-w-[180px]"
                >
          ...
          {filteredImages.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">
                {searchTerm || selectedCategory !== 'all' ? 'No Images Found' : 'No Workspace Images'}
              </h3>
