              ...
              >
                ...
                <div className="info absolute top-0 left-0 w-full h-full z-50 p-6 flex justify-between flex-col">
                  <div className="bg-black/30 backdrop-blur-sm rounded-full px-3 py-1 self-start">
                    <h4 className="text-white/90 text-[12px] font-medium">{member.role}</h4>
                  </div>
                  ...
                  <div className="content relative">
                    ...
                    <div className="flex gap-3 socials">
                      ...
                      >
                        <FaLinkedinIn size={16} className="text-white group-hover/social:text-primary transition-colors" />
                      </Link>
                      <Link
                        href="#"
                        target="_blank"
                        className="flex items-center justify-center w-10 h-10 rounded-full border border-[rgba(255,255,255,0.2)] hover:border-primary hover:bg-primary/20 transition-all duration-300 group/social"
                      >
                        <RiTwitterXLine size={16} className="text-white group-hover/social:text-primary transition-colors" />
                      </Link>
                      <Link
                        href="#"
                        target="_blank"
                        className="flex items-center justify-center w-10 h-10 rounded-full border border-[rgba(255,255,255,0.2)] hover:border-primary hover:bg-primary/20 transition-all duration-300 group/social"
                      >
                        <FaInstagram size={16} className="text-white group-hover/social:text-primary transition-colors" />
                      </Link>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                {teamData.map((member, index) => (
                  ...
                  >
                    ...
                    <div className="info absolute top-0 left-0 w-full h-full z-50 p-6 flex justify-between flex-col">
                      <div className="bg-black/30 backdrop-blur-sm rounded-full px-3 py-1 self-start">
                        <h4 className="text-white/90 text-[12px] font-medium">{member.designation}</h4>
                      </div>
